                           ...
                           const std::vector<Point2> &stroke2d)
{
    ...
    //std::cout << "Normal:" << plane_normal[0] << ", " << plane_normal[1] << ", " << plane_normal[2] << std::endl; 
    ...
    for (int i = 0; i<stroke2d.size(); i++){
        ...
        //std::cout << "Stroke Point "<< i << ": " << stroke_to_3d[i][0] << ", " << stroke_to_3d[i][1]  << ", " << stroke_to_3d[i][2]  << std::endl; 
    }
    //std::cout << "Test: " << start.DistanceToPlane(start, plane_normal)<< std::endl;
    ...
    for (int i=0; i<ground_mesh_.num_vertices(); i++) {
        ...
        if(h != 0.0){
            ...
            float w = fmax(0.0, t);
            //std::cout << "w: " << w << " ";
            //std::cout << "y: " << (1-w)*P[1]+(w*h) << std::endl;
