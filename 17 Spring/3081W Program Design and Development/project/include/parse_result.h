...
#ifndef INCLUDE_PARSE_RESULT_H_
#define INCLUDE_PARSE_RESULT_H_
 ...
 * Class Definitions
 ******************************************************************************/
/*! Creates a ParseResult that can store the nodes of an AST, and be used to
