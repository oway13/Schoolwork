...
public class ContactList {
    ...
    public static void main(String[] args) {
        ...
        NewContact c3 = new NewContact("Wyatt");
        NewContact c4 = new NewContact("Ben");
        c3.setAddress("Wyatt's Address");
        c3.setPhone(1234567891);
        c3.setComments("Comment on Wyatt");
        c3.setEmail("WyattsEmail@email.ema");
        c3.setGroup("Group With Wyatt");
        c3.setQuickRef("Kormi");
        System.out.println("toString() with new info methods: ");
        System.out.println(c3.toString());
        ContactList group = new ContactList(4);
        System.out.println("Add Sam: "+group.add(c2));
        System.out.println("Add Brito: "+group.add(c1));
        System.out.println("Add Wyatt: "+group.add(c3));
        ...
        System.out.println("Add Ben: "+group.add(c4));
